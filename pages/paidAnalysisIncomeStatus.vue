...
const makeData = () => {
    ...
    const fields = ['title', 'parentTitle', 'price'];
    makeDataTotal.value.fields = fields;
...
<template>
    <div class="bg-light pb-[40px]">
        ...
        <div
            class="container mx-auto mb-[28px] rounded-t-md bg-white pb-[39px]"
        >
            <TabControlPage />
            <div class="md:mx-[50px]">
                <div
                ...
                <div>
                    ...
                    >
                        ...
                        <SecondaryButton @click="handleAdd"
                            >追加</SecondaryButton
                        >
                    </div>
                    <TablePaidIncome
        ...
        <Modal v-model="openModal" @yes="handleYes" title="グリーンパーク川口">
            ...
            <template #footer>
                <div class="flex flex-col items-center justify-center">
                    <p class="mt-[10px] text-h6 md:text-h5 text-red">
